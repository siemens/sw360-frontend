...
export default function MergeReleaseTable({ componentId,
                                            releaseId,
                                            sourceRelease,
                ...
                _(  
                    <Form.Check type='radio'
                                ...
                                checked={sourceRelease !== null &&
                                         singleReleaseData.id === sourceRelease.id
                                        }
    ...
    const initServerPaginationConfig = () => {
        ...
        return {
            ...
            then: (data: EmbeddedLinkedReleases) => {
                return data._embedded['sw360:releaseLinks'].map((elem: LinkedRelease) => {
