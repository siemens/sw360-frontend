...
export default function ObligationView({ projectId, actionType, payload, setPayload }: 
    ...
    return (
        <Tabs defaultActiveKey='license-obligation' className='mb-3' mountOnEnter={true} unmountOnExit={true}>
            <Tab eventKey='license-obligation' title={t('License Obligation')}>
                <LicenseObligation projectId={projectId} actionType={actionType} payload={payload} setPayload={setPayload}/>
            </Tab>
